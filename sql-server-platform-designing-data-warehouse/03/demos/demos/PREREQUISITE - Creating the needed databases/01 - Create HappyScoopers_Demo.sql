...
***********/
( NAME = N'HappyScoopers_Demo', FILENAME = N'D:\Data Career\Design DWH in SSMS\ETL project using SSIS\ETL-Project-using-SSIS\HappyScoopers_Demo.mdf' , SIZE = 270336KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'HappyScoopers_Demo_log', FILENAME = N'D:\Data Career\Design DWH in SSMS\ETL project using SSIS\ETL-Project-using-SSIS\HappyScoopers_Demo_log.ldf' , SIZE = 401408KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
